...
dupe_pick<-dupe_records[c(2,4,5,7, 11, 12, 15, 17),]
...
for(z in Zones){
 ...
 Zonejoin<-left_join(Samchoice,ILchoice[,c(6,52:57)], by = 'match')
...
BSjoin<-left_join(SAMSite.BS, BS.IL.Info[,c(2:5,13,15)], by = 'match')

BSjoin$GrowthLD50<-BSjoin$LD50

#SAMGwthSites$GrowthLD50<-SAMGwthSites$LD50
