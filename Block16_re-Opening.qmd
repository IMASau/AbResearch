...
# Overall Block 16 Abundance - Criteria 1
***Increasing sub-legal and legal counts relative to the 2020 baseline.*** 

Overall legal and sub-legal abundance have been increasing across Block 16.
Legal abundance has consistently increased by 10-15% per year whereas sub-legal increases in abundance have been slower at 5-10% with an fluctuation in 2023.
Trends at reference sites are consistent with overall paterns of abundance.
...
#| fig-cap: "Asolute change in average abundance of all legal (>140 mm) and sub-legal (<140 mm) abalone counted within 10 minutes between paired divers at each reference site within Block 16 by year to 2020 baseline (red dotted line). Coloured dashed lines are hypothetical percentage change in abundance between consecutive years."
#| echo: false
#| warning: false
#| message: false
#| fig-height: 5
...
## Sub-block 16 Abundance - Criteria 2
***Evidence of a widespread trend of increasing sub-legal and legal counts across the Block.***

The are clearly spatial differences in the magnitude of abundance across sub blocks - this is consistent with the variability in spatial dynamics  of abalone populations sometimes across small spatial scales (i.e. 10s to 100s m).

Improvements in sub-legal clearly been driven by increases in 16D in 2021; sub-legal in 16A and 16C generally remained stable and only 16B has shown a decline over the survey period to below baseline level. Note: baseline 2020 abudnace in by sub-block not the global block average. Legal abundance has been increasing across all sub blocks.
