...
#' 
## ----compile and clean leg data, warning=FALSE, message=FALSE------------
...
#' 
## ----legal and sub-legal leg counts 1, echo=FALSE------------------------
...
#' 
## ----leg counts by site, results="hide"----------------------------------
...
#' **OPTION:** the dataframe can also be seperated into individual LEG sampling sites
#' 
## ----leg size frequency site data, results="hide"------------------------
...
#' 
## ----compile and clean arm data, warning=FALSE, message=FALSE------------
...
arms.df <- dplyr::rename(arms.df, tag.recep = tr)
...
#' 
## ----arm size frequency site data, results="hide"------------------------
...
#' 
## ----legal and sub-legal leg counts 2, echo=FALSE------------------------
...
#' 
## ----arm and leg combined density data, warning=FALSE--------------------
...
#' 
## ----arm and leg combined size data, warning=FALSE-----------------------
...
#' ### Size frequency plot
#' 
## ----inverted arm leg size plot, warning=FALSE, results="hide"-----------
...
#' 
## ----inverted arm leg size plot powerpoint, warning=FALSE, results="hide"----
...
selected.site <- 'SEY'
selected.season <- c('2018.Winter', '2018.Spring', '2019.Summer', '2019.Winter')
...
#' ### Density plot
#' 
## ----arm leg density plot, results='hide'--------------------------------
...
## ----association juv vs legal, echo=FALSE--------------------------------
...
#' 
## ----leg density stacked bar plot, results="hide"------------------------
...
leg.den.bar <- ggplot(sub.leg.dat, aes(x = yr.season, y = value, fill = variable))+
 ...
 scale_x_discrete(breaks = c("2015.Summer", "2015.Winter", "2015.Spring", 
                             ...
                             "2017.Summer", "2017.Winter", "2017.Spring", 
                             "2018.Summer", "2018.Winter", "2018.Spring", 
                             "2019.Summer", "2019.Winter"), labels = season_labels, drop = F)
