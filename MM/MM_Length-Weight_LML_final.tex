...
\tightlist
\item
  Investigate historical trends in size structure.
\item
  Analyze recent length-weight data to determine its effect on abalone harvest numbers and biomass.
\end{enumerate}
