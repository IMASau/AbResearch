...
```{r lwplot check, fig.cap = "Length-weight relationship of commercial abalone catch sampling data for all zones collected between 2019-2021.", echo=FALSE}
...
```{r east clean plot, fig.cap = "Length-weight relationship of cleaned commercial abalone catch sampling data for the eastern zone collected between 2019-2021.", echo=FALSE}
...
library(knitr)
kable(zone.wt, caption = "Average weight of individual abalone from commerical abalone catch sampling data for all zones collected between 2019-2021.", col.names = c('Zone', 'Av.weight<br>(g)', 'n', 'Catches'))
```
...
## Determine weight for proposed LMLs for 2020-21
...
library(knitr)
kable(lml.wt.est.tab, caption = "Estimated Recreational harvest for each LML based on estimated harvest for 2020-21 season and abalone length-weight relationship from commerical catch sampling for the eastern zone collected between 2019-2021.", col.names = c('LML', 'Est. weight<br>(g)', 'Harvest<br>(kg)', 'Harvest 95%<br>(kg)', 'Harvest 90%<br>(kg)')) 
...
library(knitr)
kable(lml.wt.est.tab.18.19, caption = "Estimated Recreational harvest for each LML based on estimated harvest for 2018-19 season and abalone length-weight relationship from commerical catch sampling for the eastern zone collected between 2019-2021.", col.names = c('LML', 'Est. weight<br>(g)', 'Harvest<br>(kg)', 'Harvest 95%<br>(kg)', 'Harvest 90%<br>(kg)')) 
...
library(knitr)
kable(lml.wt.est.df.final, caption = "Relative change in estimated Recreational harvest for an increase in LML based on estimated harvest for 2020-21 season and abalone length-weight relationship from commerical catch sampling for the eastern zone collected between 2019-2021.")
...
library(knitr)
kable(lml.wt.est.df.final.18.19, caption = "Relative change in estimated Recreational harvest for an increase in LML based on estimated harvest for 2018-19 season and abalone length-weight relationship from commerical catch sampling for the eastern zone collected between 2019-2021.")
...
library(knitr)
kable(lml.harvest.final, caption = "Estimated Recreational harvest for each LML based on estimated harvest for 2020-21 season and abalone length-weight relationship and size frequencies from commerical catch sampling for the eastern zone collected between 2019-2021.", col.names = c('LML', 'Est. Harvest<br>(kg)', 'Harvest 95%<br>(kg)', 'Harvest 90%<br>(kg)')) 
...
library(knitr)
kable(lml.harvest.final.18.19, caption = "Estimated Recreational harvest for each LML based on estimated harvest for 2018-19 season and abalone length-weight relationship and size frequencies from commerical catch sampling for the eastern zone collected between 2019-2021.", col.names = c('LML', 'Est. Harvest<br>(kg)', 'Harvest 95%<br>(kg)', 'Harvest 90%<br>(kg)')) 
...
```{r lw harvest relative change plot, fig.cap = "Estimated Recreational harvest in 2020-21 and 2018-19 for each LML based on abalone length-weight relationship and size frequencies from commerical catch sampling for the eastern zone collected between 2019-2021.", echo=FALSE}
...
library(knitr)
kable(lml.harvest.final, caption = "Relative change in estimated Recreational harvest for an increase in LML based on estimated harvest for 2020-21 season and abalone length-weight relationship and size frequencies from commerical catch sampling for the eastern zone collected between 2019-2021.")
...
library(knitr)
kable(lml.harvest.final.18.19, caption = "Relative change in estimated Recreational harvest for an increase in LML based on estimated harvest for 2018-19 season and abalone length-weight relationship and size frequencies from commerical catch sampling for the eastern zone collected between 2019-2021.")
