...
library(knitr)
kable(rec.region.wt, caption = "Average weight of individual abalone from commerical abalone catch sampling data for all recreational harvest regions collected between 2019-2025.", col.names = c('RecRegion', 'Av.weight<br>(g)', 'n', 'Catches'))
```
