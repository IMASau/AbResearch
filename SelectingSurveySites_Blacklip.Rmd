...
ts.hex <- filter(sf.ab.hex, zone == 'E' &
                  blockno %in% c(16, 21, 22, 23, 24, 27, 28)|
                  subblockno == '28A') %>%
...
# outname_point <- sprintf(paste0("C:/Users/%s/University of Tasmania/IMAS-DiveFisheries - Assessments - Documents/Assessments/GIS/SpatialLayers/TimedSwimSites_Block21_Final_", assess_year, ".gpkg", sep = ""), Sys.info()[["user"]])
