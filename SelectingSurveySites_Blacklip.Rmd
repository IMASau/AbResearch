...
# outname_point <- sprintf(paste0("C:/Users/%s/University of Tasmania/IMAS-DiveFisheries - Assessments - Documents/Assessments/GIS/SpatialLayers/TimedSwimSites_Block5-6_Final_", assess_year, ".gpkg", sep = ""), Sys.info()[["user"]])

# outname_point <- sprintf(paste0("C:/Users/%s/Dropbox (UTAS Research)/DiveFisheries/GIS/SpatialLayers/TimedSwimSites_Block29_Final_", assess_year, ".gpkg", sep = ""), Sys.info()[["user"]])
...
outname_point_kml <- sprintf(paste(sprintf("C:/Users/%s/Dropbox (UTAS Research)/DiveFisheries/GIS/SpatialLayers/TimedSwimSites_Block5-6_Final_2024.kml", Sys.info()[["user"]])))

st_write(ts_sites_final_sf, dsn = outname_point_kml, layer = "pointqt", driver = "kml", append = F) 

# outname_point_kml <- paste0('C:/CloudStor/DiveFisheries/Abalone/FISdata/FIS_TimedSwimSurveys', assess_year, '/TimedSwim_EastCoast/TimedSwimSites_Block21_Final', assess_year, ".kml", sep = "")
# st_write(ts_sites_final_sf, dsn = outname_point_kml, layer = "pointqt", driver = "kml", append = F)

# outname_point_kml <- sprintf(paste0("C:/Users/%s/Dropbox (UTAS Research)/DiveFisheries/Abalone/FISdata/FIS_TimedSwimSurveys", assess_year, "/TimedSwimSites_Block29_Final", assess_year, ".kml", sep = ""), Sys.info()[["user"]])
# st_write(ts_sites_final_sf, dsn = outname_point_kml, layer = "pointqt", driver = "kml", append = F)
 
# Export Excel files 
write.xlsx(ts_sites_final_df, sprintf(paste0("C:/Users/%s/Dropbox (UTAS Research)/DiveFisheries/GIS/SpatialLayers/TimedSwimSites_Block5-6_Final_", assess_year, ".xlsx", sep = ""), Sys.info()[["user"]]), 
            sheetName = "Sheet1", 
            colNames = TRUE, rowNames = TRUE, append = FALSE)
 
  # write.xlsx(ts_sites_final_df, sprintf(paste0("C:/Users/%s/University of Tasmania/IMAS-DiveFisheries - Assessments - Documents/Assessments/GIS/SpatialLayers/TimedSwimSites_Block21_Final", assess_year, ".xlsx", sep = ""), Sys.info()[["user"]]), 
  #           sheetName = "Sheet1", 
  #           colNames = TRUE, rowNames = TRUE, append = FALSE)
 
# write.xlsx(ts_sites_final_df, sprintf(paste0("C:/Users/%s/Dropbox (UTAS Research)/DiveFisheries/GIS/SpatialLayers/TimedSwimSites_Block29_Final", assess_year, ".xlsx", sep = ""), Sys.info()[["user"]]),
#             sheetName = "Sheet1",
#             colNames = TRUE, rowNames = TRUE, append = FALSE)
...
write.xlsx(ts_sites_final_gpx, paste0('C:/Users/%s/Dropbox (UTAS Research)/DiveFisheries/GIS/SpatialLayers/TimedSwimSites_Block5-6_Final_', assess_year, '_GPX', ".xlsx", sep = ""), 
            sheetName = "Sheet1", 
            colNames = TRUE, rowNames = FALSE, append = FALSE)

# write.xlsx(ts_sites_final_gpx, paste0('C:/CloudStor/DiveFisheries/Abalone/FISdata/FIS_TimedSwimSurveys', assess_year, '/TimedSwim_EastCoast/TimedSwimSites_Block21_Final', assess_year, '_GPX', ".xlsx", sep = ""), 
#             sheetName = "Sheet1", 
#             colNames = TRUE, rowNames = FALSE, append = FALSE)
...
# write.xlsx(ts_sites_final_gpx, sprintf(paste0("C:/Users/%s/Dropbox (UTAS Research)/DiveFisheries/Abalone/FISdata/FIS_TimedSwimSurveys", assess_year, "/TimedSwimSites_Block29_Final", assess_year, '_GPX', ".xlsx", sep = ""), Sys.info()[["user"]]))
